...
urlpatterns = [
    ...
    path('poll/report/', views.report, name='report'),
    path('setActive/<int:classroom>/', views.setActive, name='setActive'),
    path('report/<str:classroom>/attendance/', views.attendance, name='attendance'),
    path('report/<str:classroom>/attendanceform/', views.attendanceForm, name='attendanceForm'),
